  ...
  <div class="app-container">
    ...
    <el-form ref="form" :model="form" label-width="120px">
      <el-form-item
        ...
        prop="username"
      >
        <el-input v-model.number="form.username" placeholder="请输入用户名" style="width: 200px" />
      </el-form-item>
      <el-form-item
        label="姓名"
        ...
        prop="trueName"
      >
        <el-input v-model.number="form.trueName" placeholder="请输入姓名" style="width: 200px" />
      </el-form-item>
      <el-form-item
        label="密码"
        ...
        prop="password"
      >
        <el-input v-model.number="form.password" placeholder="请输入密码" style="width: 200px" />
      </el-form-item>
    ...
    submitForm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          addUser(JSON.stringify(this.form)).then(response => {
